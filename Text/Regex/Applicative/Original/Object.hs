...
--------------------------------------------------------------------
{-# LANGUAGE GADTs #-}
module Text.Regex.Applicative.Original.Object
    ( ReObject
    , compile
    , emptyObject
    , Thread
...
import qualified Text.Regex.Applicative.Original.StateQueue as SQ
import qualified Text.Regex.Applicative.Original.Compile as Compile
import Data.Maybe
